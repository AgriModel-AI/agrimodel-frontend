...
const INITIAL_VISIBLE_COLUMNS = ["name", "description", "growingConditions", "harvestTime", "actions"];

const columns = [
  { name: "Name", uid: "name", sortable: true },
  { name: "Description", uid: "description", sortable: true },
  { name: "Growing Conditions", uid: "growingConditions", sortable: true },
  { name: "Harvest Time", uid: "harvestTime", sortable: true },
...
export default function Crop() {
  ...
  }, [crops, filterValue, hasSearchFilter]);
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex justify-between gap-3 items-end">
          ...
          <div className="flex gap-3">
            <Button color="primary" endContent={<PlusIcon />} onClick={()=> {navigate("/dashboard/crops/add");}}>
              Add New
            </Button>
          </div>
        </div>
        <div className="flex justify-between items-center">
          <span className="text-default-400 text-small">Total {crops.length} crops</span>
  ...
  }, [filterValue, onSearchChange, crops.length, onRowsPerPageChange, onClear, navigate]);
  ...
  return (
    <div className="px-4 sm:px-2 md:px-10 lg:px-20 mt-4">
      ...
      >
        ...
        <TableBody emptyContent={"No crops found"} items={sortedItems}>
          {(item) => (
            <TableRow key={item.cropId}> 
              {columns.map((column) => (
