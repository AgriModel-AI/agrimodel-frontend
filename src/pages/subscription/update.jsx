...
import { getSubscriptionPlanById, updateSubscriptionPlan } from "../../redux/slices/subscriptionPlanSlice";
...
const SubscriptionPlanUpdate = () => {
  ...
  // Update form data when plan is fetched
  useEffect(() => {
    if (currentPlan) {
      setFormData({
        name: currentPlan.name || "",
        description: currentPlan.description || "",
        dailyAttempts: currentPlan.dailyAttempts || 1,
        monthlyPrice: currentPlan.monthlyPrice || 0,
        yearlyDiscountPercentage: currentPlan.yearlyDiscountPercentage || 10,
        isPlanFree: currentPlan.isPlanFree || false
      });
    }
  }, [currentPlan]);
  ...
  return (
    <div className={`px-4 md:px-8 lg:px-16 py-8`}>
      ...
      <Breadcrumbs className="mb-6">
        ...
        <BreadcrumbItem isCurrent href={`/dashboard/subscriptions/plans/update/${id}`}>Edit</BreadcrumbItem>
      </Breadcrumbs>
      ...
      <div className={`flex ${isSmallScreen ? "flex-col" : "flex-row"} justify-center items-center`}>
        <Card className="w-full max-w-lg p-6 shadow-lg">
          <form className="flex flex-col space-y-4" onSubmit={handleSubmit}>
            <h3 className="text-lg font-semibold text-center mb-2">EDIT SUBSCRIPTION PLAN</h3>
